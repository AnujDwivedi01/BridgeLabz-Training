...
public class StudentsGrade {
	...
	StudentsGrade(String name,String rollNumber,double[] marks) {
		this.name=name;
	...
	public static void main(String[] args) {
		...
		StudentsGrade student1 = new StudentsGrade("Thamarai", "ECE001", mark1);
		StudentsGrade student2 = new StudentsGrade("Kannan","CSC002",mark2);
